...
export class HotelResultApp extends BaseHotelResultApp {
    ...
    public searchSummary: BaseSearchSummaryComponent;
    public imageSlider: BaseImageSliderComponent;
    public hotelCard: BaseHotelCardComponent;
    public footer: BaseFooterComponent;
    public hotelCount: BaseHotelCountComponent;
    public noResultsFound: BaseNoResultFoundComponent;
    public filter: BaseFilterComponent;
    public floatingButton: BaseFloatingButtonComponent;
    public soldOutHotel: BaseSoldOutHotelComponent;
